...
import 'package:refyne_task/domain/entity/genral_response.dart';

class UserRepo  extends GeneralResponse  {
  int? totalCount;
  bool? incompleteResults;
  List<Items>? items;

  UserRepo({this.totalCount, this.incompleteResults, this.items});
